...
<head>
  ...
  <style>
    ...
    .form-wrapper {
    max-width: 1000px; /* Atur sesuai kebutuhan: 600px, 720px, 768px */
    width: 100%;
    padding: 50px;
}
...
<nav id="sidebar" class="sidebar">
  ...
  <ul class="nav flex-column mt-3 px-2">
    ...
    <li class="nav-item"><a href="hasil.php" class="nav-link text-white"><i class="bi bi-bar-chart-line-fill me-2"></i> Data Hasil Akhir</a><hr class="my-2 border-secondary"></li>
