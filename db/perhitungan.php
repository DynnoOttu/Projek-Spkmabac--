...
<div id="content" class="content">
  ...
  <a class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" href="#" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
    <span class="me-2 text-uppercase fw-normal"><?php ['username']; ?></span>
  ...
  <!-- Page Content -->
  <div class="p-4">
    <h3><i class="bi bi-box"></i> Data Kriteria</h3>
        ...
        <div class="card-body">
            <form method="POST" class="mb-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        <input type="number" step="0.01" min="0" max="4" name="ipk" class="form-control" placeholder="IPK" required>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" name="penghasilan" class="form-control" placeholder="Penghasilan" required>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <input type="number" min="0" max="5" name="ekstrakurik" class="form-control" placeholder="Ekstrakurikuler" required>
                    </div>
                    <div class="col-md-1">
                        <input type="number" min="0" max="5" name="prestasi" class="form-control" placeholder="Prestasi" required>
                    </div>
